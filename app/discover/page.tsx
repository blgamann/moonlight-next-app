    ...
    const dummyProfiles: ProfileData[] = [
      {
        ...
        books: [
          { id: 1, isbn: "9791190254373", title: "책임의 생성", author: "김상준", image: "https://shopping-phinf.pstatic.net/main_3246667/32466671076.20230516071308.jpg" },
          { id: 2, isbn: "9788983712042", title: "스피노자의 뇌", author: "안토니오 다마지오", image: "https://shopping-phinf.pstatic.net/main_3245604/32456041610.20220527055541.jpg" }
        ],
        answers: [
          { 
            id: 1, 
      ...
      },
      {
        ...
        books: [
          { id: 2, isbn: "9788983712042", title: "스피노자의 뇌", author: "안토니오 다마지오", image: "https://shopping-phinf.pstatic.net/main_3245604/32456041610.20220527055541.jpg" },
          { id: 3, isbn: "9788979865868", title: "논어강설", author: "김용옥", image: "https://shopping-phinf.pstatic.net/main_3246258/32462589175.20220527055541.jpg" }
        ],
        answers: [
          { 
            id: 2, 
      ...
      },
      {
        ...
        books: [
          { id: 3, isbn: "9788979865868", title: "논어강설", author: "김용옥", image: "https://shopping-phinf.pstatic.net/main_3246258/32462589175.20220527055541.jpg" },
          { id: 4, isbn: "9791166893162", title: "다윈의 위험한 생각", author: "대니얼 데닛", image: "https://shopping-phinf.pstatic.net/main_3244981/32449811618.20220527055541.jpg" }
        ],
        answers: [
          { 
            id: 3, 
            title: "논어의 현대적 해석", 
            content: "김용옥의 논어강설은 고전을 현대적으로 해석한 좋은 예입니다...", 
  ...
  return (
    <div className="min-h-screen p-4 pb-20">
      <div className="flex flex-col md:flex-row md:gap-6">
        ...
        <div className="w-full md:w-1/2 mb-6 md:mb-0">
          ...
          <div className="mb-4">
            ...
            <Soulline profiles={currentProfile.soulline.map(p => ({ imageUrl: p.image }))} />
          </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-gray-600 mb-2">다른 분들과 연결되고 싶다면 읽은 책을 검색하고 나의 감상을 공유하세요</p>
        <Link 
          href="/search" 
